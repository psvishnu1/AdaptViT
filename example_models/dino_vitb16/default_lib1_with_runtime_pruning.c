  ...
  for (int32_t ax1_outer_ax0_outer_fused = 0; ax1_outer_ax0_outer_fused < 591; ++ax1_outer_ax0_outer_fused) {
    ...
    for (int32_t y_inner_outer_x_inner_outer_fused = 0; y_inner_outer_x_inner_outer_fused < 128; ++y_inner_outer_x_inner_outer_fused) {
      for (int32_t x_c = 0; x_c < 8; ++x_c) {
        ...
        int32_t global_channel_1 = ((ax1_outer_ax0_outer_fused / 197) * 1024) + (y_inner_outer_x_inner_outer_fused * 8) + x_c;
        if (mlp_masks[(block_idx * 3072) + global_channel_1] == 0.0f) continue;
        for (int32_t k_outer = 0; k_outer < 768; ++k_outer) {
...
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_11(int16_t* p0, float* p1, float* T_multiply, float* mlp_masks, int32_t block_idx, uint8_t* global_const_workspace_102_var, uint8_t* global_workspace_103_var) {
  ...
  int32_t active_k[3072];
  int32_t n_active = 0;
  for (int32_t k = 0; k < 3072; ++k) {
    if (mlp_masks[(block_idx * 3072) + k] != 0.0f) {
      active_k[n_active++] = k;
    }
  }
  for (int32_t ax1_outer_ax0_outer_fused = 0; ax1_outer_ax0_outer_fused < 591; ++ax1_outer_ax0_outer_fused) {
...
TVM_DLL int32_t tvmgen_default___tvm_main__(
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_6_let, sid_10_let, sid_9_let, sid_11_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_12_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[0 * 12 + 0] != 0.0f || head_masks_buffer_var[0 * 12 + 1] != 0.0f || head_masks_buffer_var[0 * 12 + 2] != 0.0f || head_masks_buffer_var[0 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 4] != 0.0f || head_masks_buffer_var[0 * 12 + 5] != 0.0f || head_masks_buffer_var[0 * 12 + 6] != 0.0f || head_masks_buffer_var[0 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 8] != 0.0f || head_masks_buffer_var[0 * 12 + 9] != 0.0f || head_masks_buffer_var[0 * 12 + 10] != 0.0f || head_masks_buffer_var[0 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_13_let, sid_14_let, sid_15_let, sid_17_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[0 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_18_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_16_let, sid_17_let, sid_18_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_18_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_16_let, sid_17_let, sid_18_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_18_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_16_let, sid_17_let, sid_18_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_18_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_16_let, sid_17_let, sid_18_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_18_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_16_let, sid_17_let, sid_18_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_18_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_16_let, sid_17_let, sid_18_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[0 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_21_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_19_let, sid_20_let, sid_21_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_21_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_19_let, sid_20_let, sid_21_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_21_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_19_let, sid_20_let, sid_21_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_21_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_19_let, sid_20_let, sid_21_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_21_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_19_let, sid_20_let, sid_21_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_21_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_19_let, sid_20_let, sid_21_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_22_let, sid_26_let, sid_25_let, sid_27_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_28_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[0 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[0 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_1(sid_27_let, sid_26_let, sid_28_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_1(sid_27_let, sid_26_let, sid_28_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_1(sid_27_let, sid_26_let, sid_28_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_1(sid_27_let, sid_26_let, sid_28_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_1(sid_27_let, sid_26_let, sid_28_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[0 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_1(sid_27_let, sid_26_let, sid_28_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_49_let, sid_53_let, sid_52_let, sid_54_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_55_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[1 * 12 + 0] != 0.0f || head_masks_buffer_var[1 * 12 + 1] != 0.0f || head_masks_buffer_var[1 * 12 + 2] != 0.0f || head_masks_buffer_var[1 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 4] != 0.0f || head_masks_buffer_var[1 * 12 + 5] != 0.0f || head_masks_buffer_var[1 * 12 + 6] != 0.0f || head_masks_buffer_var[1 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 8] != 0.0f || head_masks_buffer_var[1 * 12 + 9] != 0.0f || head_masks_buffer_var[1 * 12 + 10] != 0.0f || head_masks_buffer_var[1 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_56_let, sid_57_let, sid_58_let, sid_60_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[1 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_61_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_59_let, sid_60_let, sid_61_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_61_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_59_let, sid_60_let, sid_61_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_61_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_59_let, sid_60_let, sid_61_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_61_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_59_let, sid_60_let, sid_61_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_61_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_59_let, sid_60_let, sid_61_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_61_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_59_let, sid_60_let, sid_61_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[1 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_64_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_62_let, sid_63_let, sid_64_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_64_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_62_let, sid_63_let, sid_64_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_64_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_62_let, sid_63_let, sid_64_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_64_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_62_let, sid_63_let, sid_64_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_64_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_62_let, sid_63_let, sid_64_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_64_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_62_let, sid_63_let, sid_64_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_65_let, sid_69_let, sid_68_let, sid_70_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_71_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[1 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[1 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_5(sid_70_let, sid_69_let, sid_71_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_5(sid_70_let, sid_69_let, sid_71_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_5(sid_70_let, sid_69_let, sid_71_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_5(sid_70_let, sid_69_let, sid_71_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_5(sid_70_let, sid_69_let, sid_71_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[1 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_5(sid_70_let, sid_69_let, sid_71_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_92_let, sid_96_let, sid_95_let, sid_97_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_98_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[2 * 12 + 0] != 0.0f || head_masks_buffer_var[2 * 12 + 1] != 0.0f || head_masks_buffer_var[2 * 12 + 2] != 0.0f || head_masks_buffer_var[2 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 4] != 0.0f || head_masks_buffer_var[2 * 12 + 5] != 0.0f || head_masks_buffer_var[2 * 12 + 6] != 0.0f || head_masks_buffer_var[2 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 8] != 0.0f || head_masks_buffer_var[2 * 12 + 9] != 0.0f || head_masks_buffer_var[2 * 12 + 10] != 0.0f || head_masks_buffer_var[2 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_99_let, sid_100_let, sid_101_let, sid_103_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[2 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_104_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_102_let, sid_103_let, sid_104_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_104_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_102_let, sid_103_let, sid_104_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_104_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_102_let, sid_103_let, sid_104_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_104_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_102_let, sid_103_let, sid_104_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_104_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_102_let, sid_103_let, sid_104_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_104_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_102_let, sid_103_let, sid_104_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[2 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_107_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_105_let, sid_106_let, sid_107_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_107_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_105_let, sid_106_let, sid_107_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_107_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_105_let, sid_106_let, sid_107_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_107_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_105_let, sid_106_let, sid_107_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_107_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_105_let, sid_106_let, sid_107_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_107_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_105_let, sid_106_let, sid_107_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_108_let, sid_112_let, sid_111_let, sid_113_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_114_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[2 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[2 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_9(sid_113_let, sid_112_let, sid_114_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_9(sid_113_let, sid_112_let, sid_114_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_9(sid_113_let, sid_112_let, sid_114_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_9(sid_113_let, sid_112_let, sid_114_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_9(sid_113_let, sid_112_let, sid_114_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[2 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_9(sid_113_let, sid_112_let, sid_114_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_135_let, sid_139_let, sid_138_let, sid_140_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_141_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[3 * 12 + 0] != 0.0f || head_masks_buffer_var[3 * 12 + 1] != 0.0f || head_masks_buffer_var[3 * 12 + 2] != 0.0f || head_masks_buffer_var[3 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 4] != 0.0f || head_masks_buffer_var[3 * 12 + 5] != 0.0f || head_masks_buffer_var[3 * 12 + 6] != 0.0f || head_masks_buffer_var[3 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 8] != 0.0f || head_masks_buffer_var[3 * 12 + 9] != 0.0f || head_masks_buffer_var[3 * 12 + 10] != 0.0f || head_masks_buffer_var[3 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_142_let, sid_143_let, sid_144_let, sid_146_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[3 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_147_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_145_let, sid_146_let, sid_147_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_147_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_145_let, sid_146_let, sid_147_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_147_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_145_let, sid_146_let, sid_147_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_147_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_145_let, sid_146_let, sid_147_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_147_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_145_let, sid_146_let, sid_147_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_147_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_145_let, sid_146_let, sid_147_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[3 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_150_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_148_let, sid_149_let, sid_150_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_150_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_148_let, sid_149_let, sid_150_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_150_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_148_let, sid_149_let, sid_150_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_150_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_148_let, sid_149_let, sid_150_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_150_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_148_let, sid_149_let, sid_150_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_150_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_148_let, sid_149_let, sid_150_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_151_let, sid_155_let, sid_154_let, sid_156_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_157_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[3 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[3 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_13(sid_156_let, sid_155_let, sid_157_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_13(sid_156_let, sid_155_let, sid_157_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_13(sid_156_let, sid_155_let, sid_157_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_13(sid_156_let, sid_155_let, sid_157_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_13(sid_156_let, sid_155_let, sid_157_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[3 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_13(sid_156_let, sid_155_let, sid_157_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_178_let, sid_182_let, sid_181_let, sid_183_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_184_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[4 * 12 + 0] != 0.0f || head_masks_buffer_var[4 * 12 + 1] != 0.0f || head_masks_buffer_var[4 * 12 + 2] != 0.0f || head_masks_buffer_var[4 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 4] != 0.0f || head_masks_buffer_var[4 * 12 + 5] != 0.0f || head_masks_buffer_var[4 * 12 + 6] != 0.0f || head_masks_buffer_var[4 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 8] != 0.0f || head_masks_buffer_var[4 * 12 + 9] != 0.0f || head_masks_buffer_var[4 * 12 + 10] != 0.0f || head_masks_buffer_var[4 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_185_let, sid_186_let, sid_187_let, sid_189_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[4 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_190_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_188_let, sid_189_let, sid_190_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_190_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_188_let, sid_189_let, sid_190_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_190_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_188_let, sid_189_let, sid_190_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_190_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_188_let, sid_189_let, sid_190_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_190_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_188_let, sid_189_let, sid_190_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_190_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_188_let, sid_189_let, sid_190_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[4 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_193_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_191_let, sid_192_let, sid_193_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_193_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_191_let, sid_192_let, sid_193_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_193_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_191_let, sid_192_let, sid_193_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_193_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_191_let, sid_192_let, sid_193_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_193_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_191_let, sid_192_let, sid_193_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_193_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_191_let, sid_192_let, sid_193_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_194_let, sid_198_let, sid_197_let, sid_199_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_200_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[4 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[4 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_17(sid_199_let, sid_198_let, sid_200_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_17(sid_199_let, sid_198_let, sid_200_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_17(sid_199_let, sid_198_let, sid_200_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_17(sid_199_let, sid_198_let, sid_200_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_17(sid_199_let, sid_198_let, sid_200_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[4 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_17(sid_199_let, sid_198_let, sid_200_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_221_let, sid_225_let, sid_224_let, sid_226_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_227_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[5 * 12 + 0] != 0.0f || head_masks_buffer_var[5 * 12 + 1] != 0.0f || head_masks_buffer_var[5 * 12 + 2] != 0.0f || head_masks_buffer_var[5 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 4] != 0.0f || head_masks_buffer_var[5 * 12 + 5] != 0.0f || head_masks_buffer_var[5 * 12 + 6] != 0.0f || head_masks_buffer_var[5 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 8] != 0.0f || head_masks_buffer_var[5 * 12 + 9] != 0.0f || head_masks_buffer_var[5 * 12 + 10] != 0.0f || head_masks_buffer_var[5 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_228_let, sid_229_let, sid_230_let, sid_232_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[5 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_233_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_231_let, sid_232_let, sid_233_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_233_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_231_let, sid_232_let, sid_233_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_233_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_231_let, sid_232_let, sid_233_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_233_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_231_let, sid_232_let, sid_233_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_233_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_231_let, sid_232_let, sid_233_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_233_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_231_let, sid_232_let, sid_233_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[5 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_236_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_234_let, sid_235_let, sid_236_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_236_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_234_let, sid_235_let, sid_236_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_236_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_234_let, sid_235_let, sid_236_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_236_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_234_let, sid_235_let, sid_236_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_236_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_234_let, sid_235_let, sid_236_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_236_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_234_let, sid_235_let, sid_236_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_237_let, sid_241_let, sid_240_let, sid_242_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_243_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[5 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[5 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_21(sid_242_let, sid_241_let, sid_243_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_21(sid_242_let, sid_241_let, sid_243_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_21(sid_242_let, sid_241_let, sid_243_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_21(sid_242_let, sid_241_let, sid_243_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_21(sid_242_let, sid_241_let, sid_243_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[5 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_21(sid_242_let, sid_241_let, sid_243_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_264_let, sid_268_let, sid_267_let, sid_269_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_270_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[6 * 12 + 0] != 0.0f || head_masks_buffer_var[6 * 12 + 1] != 0.0f || head_masks_buffer_var[6 * 12 + 2] != 0.0f || head_masks_buffer_var[6 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 4] != 0.0f || head_masks_buffer_var[6 * 12 + 5] != 0.0f || head_masks_buffer_var[6 * 12 + 6] != 0.0f || head_masks_buffer_var[6 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 8] != 0.0f || head_masks_buffer_var[6 * 12 + 9] != 0.0f || head_masks_buffer_var[6 * 12 + 10] != 0.0f || head_masks_buffer_var[6 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_271_let, sid_272_let, sid_273_let, sid_275_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[6 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_276_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_274_let, sid_275_let, sid_276_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_276_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_274_let, sid_275_let, sid_276_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_276_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_274_let, sid_275_let, sid_276_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_276_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_274_let, sid_275_let, sid_276_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_276_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_274_let, sid_275_let, sid_276_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_276_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_274_let, sid_275_let, sid_276_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[6 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_279_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_277_let, sid_278_let, sid_279_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_279_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_277_let, sid_278_let, sid_279_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_279_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_277_let, sid_278_let, sid_279_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_279_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_277_let, sid_278_let, sid_279_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_279_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_277_let, sid_278_let, sid_279_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_279_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_277_let, sid_278_let, sid_279_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_280_let, sid_284_let, sid_283_let, sid_285_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_286_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[6 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[6 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_25(sid_285_let, sid_284_let, sid_286_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_25(sid_285_let, sid_284_let, sid_286_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_25(sid_285_let, sid_284_let, sid_286_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_25(sid_285_let, sid_284_let, sid_286_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_25(sid_285_let, sid_284_let, sid_286_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[6 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_25(sid_285_let, sid_284_let, sid_286_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_307_let, sid_311_let, sid_310_let, sid_312_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_313_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[7 * 12 + 0] != 0.0f || head_masks_buffer_var[7 * 12 + 1] != 0.0f || head_masks_buffer_var[7 * 12 + 2] != 0.0f || head_masks_buffer_var[7 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 4] != 0.0f || head_masks_buffer_var[7 * 12 + 5] != 0.0f || head_masks_buffer_var[7 * 12 + 6] != 0.0f || head_masks_buffer_var[7 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 8] != 0.0f || head_masks_buffer_var[7 * 12 + 9] != 0.0f || head_masks_buffer_var[7 * 12 + 10] != 0.0f || head_masks_buffer_var[7 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_314_let, sid_315_let, sid_316_let, sid_318_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[7 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_319_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_317_let, sid_318_let, sid_319_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_319_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_317_let, sid_318_let, sid_319_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_319_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_317_let, sid_318_let, sid_319_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_319_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_317_let, sid_318_let, sid_319_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_319_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_317_let, sid_318_let, sid_319_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_319_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_317_let, sid_318_let, sid_319_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[7 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_322_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_320_let, sid_321_let, sid_322_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_322_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_320_let, sid_321_let, sid_322_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_322_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_320_let, sid_321_let, sid_322_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_322_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_320_let, sid_321_let, sid_322_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_322_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_320_let, sid_321_let, sid_322_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_322_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_320_let, sid_321_let, sid_322_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_323_let, sid_327_let, sid_326_let, sid_328_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_329_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[7 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[7 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_29(sid_328_let, sid_327_let, sid_329_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_29(sid_328_let, sid_327_let, sid_329_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_29(sid_328_let, sid_327_let, sid_329_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_29(sid_328_let, sid_327_let, sid_329_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_29(sid_328_let, sid_327_let, sid_329_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[7 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_29(sid_328_let, sid_327_let, sid_329_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_350_let, sid_354_let, sid_353_let, sid_355_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_356_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[8 * 12 + 0] != 0.0f || head_masks_buffer_var[8 * 12 + 1] != 0.0f || head_masks_buffer_var[8 * 12 + 2] != 0.0f || head_masks_buffer_var[8 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 4] != 0.0f || head_masks_buffer_var[8 * 12 + 5] != 0.0f || head_masks_buffer_var[8 * 12 + 6] != 0.0f || head_masks_buffer_var[8 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 8] != 0.0f || head_masks_buffer_var[8 * 12 + 9] != 0.0f || head_masks_buffer_var[8 * 12 + 10] != 0.0f || head_masks_buffer_var[8 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_357_let, sid_358_let, sid_359_let, sid_361_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[8 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_362_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_360_let, sid_361_let, sid_362_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_362_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_360_let, sid_361_let, sid_362_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_362_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_360_let, sid_361_let, sid_362_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_362_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_360_let, sid_361_let, sid_362_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_362_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_360_let, sid_361_let, sid_362_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_362_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_360_let, sid_361_let, sid_362_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[8 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_365_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_363_let, sid_364_let, sid_365_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_365_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_363_let, sid_364_let, sid_365_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_365_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_363_let, sid_364_let, sid_365_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_365_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_363_let, sid_364_let, sid_365_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_365_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_363_let, sid_364_let, sid_365_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_365_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_363_let, sid_364_let, sid_365_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_366_let, sid_370_let, sid_369_let, sid_371_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_372_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[8 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[8 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_33(sid_371_let, sid_370_let, sid_372_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_33(sid_371_let, sid_370_let, sid_372_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_33(sid_371_let, sid_370_let, sid_372_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_33(sid_371_let, sid_370_let, sid_372_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_33(sid_371_let, sid_370_let, sid_372_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[8 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_33(sid_371_let, sid_370_let, sid_372_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_393_let, sid_397_let, sid_396_let, sid_398_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_399_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[9 * 12 + 0] != 0.0f || head_masks_buffer_var[9 * 12 + 1] != 0.0f || head_masks_buffer_var[9 * 12 + 2] != 0.0f || head_masks_buffer_var[9 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 4] != 0.0f || head_masks_buffer_var[9 * 12 + 5] != 0.0f || head_masks_buffer_var[9 * 12 + 6] != 0.0f || head_masks_buffer_var[9 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 8] != 0.0f || head_masks_buffer_var[9 * 12 + 9] != 0.0f || head_masks_buffer_var[9 * 12 + 10] != 0.0f || head_masks_buffer_var[9 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_400_let, sid_401_let, sid_402_let, sid_404_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[9 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_405_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_403_let, sid_404_let, sid_405_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_405_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_403_let, sid_404_let, sid_405_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_405_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_403_let, sid_404_let, sid_405_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_405_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_403_let, sid_404_let, sid_405_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_405_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_403_let, sid_404_let, sid_405_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_405_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_403_let, sid_404_let, sid_405_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[9 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_408_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_406_let, sid_407_let, sid_408_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_408_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_406_let, sid_407_let, sid_408_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_408_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_406_let, sid_407_let, sid_408_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_408_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_406_let, sid_407_let, sid_408_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_408_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_406_let, sid_407_let, sid_408_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_408_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_406_let, sid_407_let, sid_408_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_409_let, sid_413_let, sid_412_let, sid_414_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_415_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[9 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[9 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_37(sid_414_let, sid_413_let, sid_415_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_37(sid_414_let, sid_413_let, sid_415_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_37(sid_414_let, sid_413_let, sid_415_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_37(sid_414_let, sid_413_let, sid_415_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_37(sid_414_let, sid_413_let, sid_415_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[9 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_37(sid_414_let, sid_413_let, sid_415_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_436_let, sid_440_let, sid_439_let, sid_441_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_442_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[10 * 12 + 0] != 0.0f || head_masks_buffer_var[10 * 12 + 1] != 0.0f || head_masks_buffer_var[10 * 12 + 2] != 0.0f || head_masks_buffer_var[10 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 4] != 0.0f || head_masks_buffer_var[10 * 12 + 5] != 0.0f || head_masks_buffer_var[10 * 12 + 6] != 0.0f || head_masks_buffer_var[10 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 8] != 0.0f || head_masks_buffer_var[10 * 12 + 9] != 0.0f || head_masks_buffer_var[10 * 12 + 10] != 0.0f || head_masks_buffer_var[10 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_443_let, sid_444_let, sid_445_let, sid_447_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[10 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_448_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_446_let, sid_447_let, sid_448_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_448_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_446_let, sid_447_let, sid_448_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_448_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_446_let, sid_447_let, sid_448_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_448_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_446_let, sid_447_let, sid_448_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_448_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_446_let, sid_447_let, sid_448_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_448_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_446_let, sid_447_let, sid_448_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[10 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_451_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_449_let, sid_450_let, sid_451_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_451_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_449_let, sid_450_let, sid_451_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_451_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_449_let, sid_450_let, sid_451_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_451_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_449_let, sid_450_let, sid_451_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_451_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_449_let, sid_450_let, sid_451_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_451_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_449_let, sid_450_let, sid_451_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_452_let, sid_456_let, sid_455_let, sid_457_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_458_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[10 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[10 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_41(sid_457_let, sid_456_let, sid_458_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_41(sid_457_let, sid_456_let, sid_458_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_41(sid_457_let, sid_456_let, sid_458_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_41(sid_457_let, sid_456_let, sid_458_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_41(sid_457_let, sid_456_let, sid_458_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[10 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_41(sid_457_let, sid_456_let, sid_458_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_479_let, sid_483_let, sid_482_let, sid_484_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_485_let, 0, 453888 * sizeof(float));
  if (head_masks_buffer_var[11 * 12 + 0] != 0.0f || head_masks_buffer_var[11 * 12 + 1] != 0.0f || head_masks_buffer_var[11 * 12 + 2] != 0.0f || head_masks_buffer_var[11 * 12 + 3] != 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 4] != 0.0f || head_masks_buffer_var[11 * 12 + 5] != 0.0f || head_masks_buffer_var[11 * 12 + 6] != 0.0f || head_masks_buffer_var[11 * 12 + 7] != 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 8] != 0.0f || head_masks_buffer_var[11 * 12 + 9] != 0.0f || head_masks_buffer_var[11 * 12 + 10] != 0.0f || head_masks_buffer_var[11 * 12 + 11] != 0.0f) {
  ...
  if (tvmgen_default_fused_squeeze_transpose_broadcast_to_reshape(sid_486_let, sid_487_let, sid_488_let, sid_490_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    if (head_masks_buffer_var[11 * 12 + 0] == 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 1] == 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 2] == 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 3] == 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 4] == 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 5] == 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_491_let + (232854) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_489_let, sid_490_let, sid_491_let, 232854, 271663, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_491_let + (271663) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_489_let, sid_490_let, sid_491_let, 271663, 310472, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_491_let + (310472) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_489_let, sid_490_let, sid_491_let, 310472, 349281, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_491_let + (349281) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_489_let, sid_490_let, sid_491_let, 349281, 388090, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_491_let + (388090) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_489_let, sid_490_let, sid_491_let, 388090, 426899, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_491_let + (426899) * sizeof(float), 0, 38809 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul(sid_489_let, sid_490_let, sid_491_let, 426899, 465708, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (head_masks_buffer_var[11 * 12 + 6] == 0.0f) {
    memset((uint8_t*)sid_494_let + (75648) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_492_let, sid_493_let, sid_494_let, 9456, 11032, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 7] == 0.0f) {
    memset((uint8_t*)sid_494_let + (88256) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_492_let, sid_493_let, sid_494_let, 11032, 12608, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 8] == 0.0f) {
    memset((uint8_t*)sid_494_let + (100864) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_492_let, sid_493_let, sid_494_let, 12608, 14184, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 9] == 0.0f) {
    memset((uint8_t*)sid_494_let + (113472) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_492_let, sid_493_let, sid_494_let, 14184, 15760, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 10] == 0.0f) {
    memset((uint8_t*)sid_494_let + (126080) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_492_let, sid_493_let, sid_494_let, 15760, 17336, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 11] == 0.0f) {
    memset((uint8_t*)sid_494_let + (138688) * sizeof(float), 0, 12608 * sizeof(float));
  } else {
    if (tvmgen_default_fused_nn_batch_matmul_1(sid_492_let, sid_493_let, sid_494_let, 17336, 18912, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  ...
  if (tvmgen_default_fused_divide_round_divide_negative_clip_round_cast_cast_add_clip_cast_contrib_re_eee3bcbb2e5e2e0c_(sid_495_let, sid_499_let, sid_498_let, sid_500_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
    memset(sid_501_let, 0, 151296 * sizeof(float));
  if (head_masks_buffer_var[11 * 12 + 0] != 0.0f) {
  ...
  if (head_masks_buffer_var[11 * 12 + 6] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_45(sid_500_let, sid_499_let, sid_501_let, 384, 448, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 7] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_45(sid_500_let, sid_499_let, sid_501_let, 448, 512, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 8] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_45(sid_500_let, sid_499_let, sid_501_let, 512, 576, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 9] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_45(sid_500_let, sid_499_let, sid_501_let, 576, 640, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 10] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_45(sid_500_let, sid_499_let, sid_501_let, 640, 704, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
  if (head_masks_buffer_var[11 * 12 + 11] != 0.0f) {
    if (tvmgen_default_fused_nn_contrib_dense_pack_cast_multiply_multiply_45(sid_500_let, sid_499_let, sid_501_let, 704, 768, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  }
